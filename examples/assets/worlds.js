import{Z as l,B as c,a as m,C as d}from"./web-ifc-api-r1ed24cU.js";import{T as p,L as s,m as r}from"./index-ByMLC5eT.js";import{S as u}from"./stats.min-GTpOrGrX.js";import{C as b,W as g,S as h}from"./index-BGWJRE0q.js";import{S as y,a as f}from"./simple-renderer-BtbdVdIL.js";import"./_commonjsHelpers-Cpj98o6Y.js";const w=document.getElementById("container"),o=new b,L=o.get(g),e=L.create();e.scene=new y(o);e.renderer=new f(o,w);e.camera=new h(o);o.init();e.scene.setup();e.scene.three.background=null;const v=new l({color:"#6528D7",transparent:!0,opacity:.2}),C=new c,i=new m(C,v);e.scene.three.add(i);i.rotation.x+=Math.PI/4.2;i.rotation.y+=Math.PI/4.2;i.rotation.z+=Math.PI/4.2;i.updateMatrixWorld();e.camera.controls.setLookAt(3,3,3,0,0,0);const n=new u;n.showPanel(2);document.body.append(n.dom);n.dom.style.left="0px";n.dom.style.zIndex="unset";e.renderer.onBeforeUpdate.add(()=>n.begin());e.renderer.onAfterUpdate.add(()=>n.end());p.init();const a=s.create(()=>r`
